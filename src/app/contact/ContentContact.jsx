      ...
      <div className="content__contact">
        <div className="content__contact-box">
          ...
          <div className="content__contact-box-body">
            <h4 className="big">{CompanyName}</h4>
            <p>{CompanyTagline}</p>
          </div>
        </div>
        <div className="content__contact-desc">
          <p className="uniq">{CompanyDescription}</p>
        </div>
        <div className="content__contact-links">
          <a href={phone} className="content__contact-link">
            {phoneSvg}
            {phone}
          </a>
          <a href={email} className="content__contact-link">
            {mailSvg}
            {email}
          </a>
        </div>
